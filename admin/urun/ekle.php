    ...
    <div class="container">
		...
		if($_POST){
		    ...
		    try{
		        ...
		        $sorgu = "INSERT INTO urunler SET urunadi=:urunadi, aciklama=:aciklama, fiyat=:fiyat, giris_tarihi=:giris_tarihi, resim=:resim, kategori_id=:kategori_id";
		        ...
		        if($stmt->execute()){
					...
					if($resim){
					    ...
					    // sha1_file() fonksiyonu ile benzersiz bir dosya adı oluşturulur
						...
						// yüklenen dosyanın resim olduğundan emin ol
						$kontrol = getimagesize($_FILES["resim"]["tmp_name"]);
						if($kontrol!==false){
						    // yüklenen dosya bir resim dosyası
						}
						else{
						    $dosya_yukleme_hata_msj.="<div>Yüklenen dosya bir resim dosyası değil.</div>";
						}
