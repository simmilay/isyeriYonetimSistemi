...
<div class="container">
	...
	<?php
		...
		echo "<a href='#' id='btn_sil' class='col-xs col-md m-r-1em m-b-1em pull-left btn btn-danger'><span class='glyphicon glyphicon glyphicon-remove'></span> Seçilenleri Sil</a>";
	  ...
	  <div class="row">
	    <div class="col-xs-6 col-md-4 pull-right">
	      <div class="input-group">
	        <input type="text" class="form-control" placeholder="Ürün ara" name="aranan" value="<?php echo $aranan; ?>"/> 
	...
	<?php
		...
		if($sayi>0){
		    ...
		    echo "<table class='table table-hover table-responsive table-bordered'>"; //tablo başlangıcı
