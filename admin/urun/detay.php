    ...
    <div class="container">
		...
		// aktif kayıt bilgileri oku
		try {
		    // seçme sorgusunu hazırla
		    $sorgu = "SELECT urunler.id, urunler.urunadi, urunler.aciklama, urunler.fiyat, urunler.resim, kategoriler.kategoriadi FROM urunler LEFT JOIN kategoriler ON urunler.kategori_id = kategoriler.id WHERE urunler.id = ? LIMIT 0,1";
		...
		<table class='table table-hover table-responsive table-bordered'>
		    ...
		    <tr>
			    <td>Resim</td>
			    <td><?php echo $resim ? "<img src='../../content/images/{$resim}' style='width:300px;' />" : "Ürün görseli yok."; ?></td>
			</tr>
		    <tr>
		        <td></td>
		        <td>
