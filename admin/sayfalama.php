  ...
  <div class="row">
    <div class="col-xs-3 col-md-2 pull-right">
      <div class="input-group">
        ...
        <!-- <input type="text" class="form-control" placeholder="Sayfaya git" name="sayfa" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));"/> -->
