<?php include "../header.php"; ?>
    ...
    <div class="container">
	    ...
	    try {
	        ...
	        $sorgu = "SELECT id, adsoyad, kadi, sifre FROM kullanicilar WHERE id = ? LIMIT 0,1";
	    ...
	    if($_POST){
	        ...
	        try{
	            ...
	            $sorgu = "UPDATE kullanicilar SET adsoyad=:adsoyad, kadi=:kadi, sifre=:sifre WHERE id = :id";
	    ...
	    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]."?id={$id}");?>" method="post">
	        <table class='table table-hover table-responsive table-bordered'>
	            <tr>
	                <td>Ad ve Soyad</td>
	                <td><input type='text' name='adsoyad' value="<?php echo htmlspecialchars($adsoyad, ENT_QUOTES); ?>" class='form-control' /></td>
	            </tr>
	            <tr>
	                <td>Kullanıcı adı</td>
	                <td><input type='text' name='kadi' value="<?php echo htmlspecialchars($kadi, ENT_QUOTES); ?>" class='form-control' /></td>
	            </tr>
	            <tr>
	                <td>Şifre</td>
	                <td><input type='password' name='sifre' value="<?php echo htmlspecialchars($sifre, ENT_QUOTES); ?>" class='form-control' /></td>
	            </tr>	            
	            <tr>
	                <td></td>
	                <td>
