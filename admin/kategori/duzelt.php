...
<div class="container">
	...
	<?php
	    ...
	    try {
	        ...
	        $sorgu = "SELECT id, kategoriadi, aciklama FROM kategoriler WHERE id = ? LIMIT 0,1";
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}");?>" method="post">
        <table class='table table-hover table-responsive table-bordered'>
            <tr>
                <td>Kategori adı</td>
                <td><input type='text' name='kategoriadi' value="<?php echo htmlspecialchars($kategoriadi, ENT_QUOTES);  ?>" class='form-control' /></td>
            </tr>
            <tr>
                <td>Açıklama</td>
