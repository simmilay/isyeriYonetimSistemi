	...
	<div class="row">
		<div class="col-md-3">
		    <div><!--kategoriler-->
                ...
                <ul class="list-group list-group-flush">
                  <?php 
					...
					$sorgu='SELECT kategoriler.*, COUNT(urunler.id) AS adet FROM kategoriler LEFT JOIN urunler ON kategoriler.id=urunler.kategori_id GROUP BY kategoriler.id ORDER BY kategoriler.kategoriadi';
            ...
            <div class="pt-4"><!--sıralama-->
				...
				<div class="list-group list-group-flush">
				  ...
				  <a href="urunler.php?siralama=akilli<?php echo $parametre ?>" class="list-group-item list-group-item-action<?php echo $siralama=="akilli" ? "active":""; ?>">Akıllı sıralama</a>
				  <a href="urunler.php?siralama=yeni<?php echo $parametre ?>" class="list-group-item list-group-item-action<?php echo $siralama=="yeni" ? "active":""; ?>">Yeni ürünler</a>  
				  <a href="urunler.php?siralama=artan<?php echo $parametre ?>" class="list-group-item list-group-item-action<?php echo $siralama=="artan" ? "active":""; ?>">Artan fiyat</a>
				  <a href="urunler.php?siralama=azalan<?php echo $parametre ?>" class="list-group-item list-group-item-action<?php echo $siralama=="azalan" ? "active":""; ?>">Azalan fiyat</a>
				</div>
			</div><!--/sıralama-->
			<div class="pt-4"><!--fiyat-->
				...
				<div class="list-group list-group-flush">
				  ...
				  <a href="urunler.php?fiyat=0<?php echo $parametre ?>" class="list-group-item list-group-item-action<?php echo $fiyat=="0" ? "active":""; ?>">Yok</a>
				  <a href="urunler.php?fiyat=1<?php echo $parametre ?>" class="list-group-item list-group-item-action<?php echo $fiyat=="1" ? "active":""; ?>">0 - 25 &#8378;</a>
				  <a href="urunler.php?fiyat=2<?php echo $parametre ?>" class="list-group-item list-group-item-action<?php echo $fiyat=="2" ? "active":""; ?>">25 - 50 &#8378;</a>
				  <a href="urunler.php?fiyat=3<?php echo $parametre ?>" class="list-group-item list-group-item-action<?php echo $fiyat=="3" ? "active":""; ?>">50 - 100 &#8378;</a>
				  <a href="urunler.php?fiyat=4<?php echo $parametre ?>" class="list-group-item list-group-item-action<?php echo $fiyat=="4" ? "active":""; ?>">100 - 250 &#8378;</a>
				  <a href="urunler.php?fiyat=5<?php echo $parametre ?>" class="list-group-item list-group-item-action<?php echo $fiyat=="5" ? "active":""; ?>">250 - 500 &#8378;</a>
				  <a href="urunler.php?fiyat=6<?php echo $parametre ?>" class="list-group-item list-group-item-action<?php echo $fiyat=="6" ? "active":""; ?>">500 - 1000 &#8378;</a>
				</div>
			</div><!--/fiyat-->
		</div>
		<!-- Ürün listesi -->
		...
		<div class="col-md-9">
			<div class="row">
				...
				if(isset($where1) && isset($where2)) $where="(".$where1.") and (".$where2.") and (".$where3.")";
	            ...
	            include 'config/vtabani.php';
	            // kayıt listeleme sorgusu
	            $sorgu="select id, urunadi, aciklama, fiyat, resim from urunler where $where order by $orderby";
	            $stmt = $con->prepare($sorgu); // sorguyu hazırla
	            $stmt->execute(); // sorguyu çalıştır
	            $veri = $stmt->fetchAll(PDO::FETCH_ASSOC); // tablo verilerini oku
	            foreach ($veri as $kayit) { ?> 
