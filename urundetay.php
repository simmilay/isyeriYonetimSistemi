...
<div class="container mt-4 mb-4">
	<div class="row">
		...
		<div class="col-md-6">
			...
			<p><a href="urunler.php?id=<?php echo $kategori_id ?>" class="btn btn-dark p-3"><?php echo $kategoriadi ?>  kategorisindeki diğer ürünler</a></p>
		</div>
	</div>
	<!-- Diğer ürünler -->
